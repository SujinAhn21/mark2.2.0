...
class AudioViLDConfig:
    def __init__(self, mark_version="mark2.2.0"):
        ...
        # === 학습 파라미터 ===
        self.batch_size = 16
        self.num_epochs = 80 # epoch 100에서 80으로 조정
        self.learning_rate = 1e-4

        self.text_loss_weight = 1.0
        self.image_loss_weight = 1.0

        self.device = "cuda" if torch.cuda.is_available() else "cpu" # gpu 사용할 수 있도록 설정

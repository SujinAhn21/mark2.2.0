...
'''코랩 실행시 불필요 unnecessary when you run this with colab'''
...
'''코랩 드라이브 경로로 조정'''
def process_audio_files(input_dir="/content/drive/MyDrive/mark2.2.0/data",
                        output_dir="/content/drive/MyDrive/mark2.2.0/data_wav"):
